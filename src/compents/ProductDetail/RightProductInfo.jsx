...
const RightProductInfo = () => {
  ...
  const [isFavorite, setIsFavorite] = useState(false); // ❤️ toggle state
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-2">
            <button className="rounded-full bg-[#A0BCE0] w-5 h-5 border border-gray-800 hover:scale-110 transition"></button>
            <button className="rounded-full bg-[#E07575] w-5 h-5 border border-gray-800 hover:scale-110 transition"></button>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 pt-2">
          ...
          {/* Buy Now */}
          <button className="px-6 py-2 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 transition">
            Buy Now
          </button>
