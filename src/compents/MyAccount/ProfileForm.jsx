      ...
      <div className="w-full md:w-3/4 bg-white p-6 rounded-lg shadow-sm border border-gray-100 mb-32">
        ...
        <form className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                placeholder="Md"
                className="w-full border-none rounded-sm px-3 py-2 bg-[#F5F5F5] focus:outline-none "
              />
            </div>
            ...
            {/* Email and Address */}
            <div>
              <label className="block text-xl mb-1 text-[#000000]">Email</label>
              <input
                type="text"
          ...
          <div className="flex justify-end items-center space-x-4 pt-4">
            ...
            <button
              type="submit"
              className="text-[#FAFAFA] bg-[#DB4444] px-5 py-2 rounded-md transition"
            >
              Save Changes
            </button>
          </div>
